      ...
      <div id="PlayView">
        <div id="TeamAView">
            ...
            <div className="answer-box">
                ...
                {state.team1Finish &&
                    <>
                        <h4>Results</h4>
                        <p>Final Score: {state.team1TotalScore} {state.team2Finish && state.team2TotalScore <= state.team1TotalScore && playControl.doWinSound() && <span className="winner-badge"></span>}</p>
        ...
        <div id="TeamBView">
            ...
            {state.team2Finish &&
                <>
                    <h4>Results</h4>
                    <p>Final Score: {state.team2TotalScore} {state.team1Finish && state.team1TotalScore <= state.team2TotalScore && playControl.doWinSound() && <span className="winner-badge"></span>}</p>
                        <div className="results-box">
                            <h4>Question Scores</h4>
                            <ul>
